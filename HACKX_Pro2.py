...
os.system('espeak -a 300 "WELCOME TO RIDDU RANDOM CLONING TOOLS"')
logo = ("""
\033[1;32m    ╔═════════════════  𝘼𝘿𝙈𝙄𝙉 𝙄𝙉𝙁𝙍𝙊  ══════════════╗
\033[1;32m    ║     [🍁] CREATED BY   :  𝑯𝑹𝑰𝑫𝑶𝒀 𝑯𝑶𝑺𝑺𝑨𝑰𝑵      ║
\033[1;32m    ║     [🍁] FACEBOK      :  𝑹𝑶𝑫𝑵𝑬𝒀  𝑪𝒀𝑷𝑹𝑰𝑨𝑵     ║
\033[1;32m    ║     [🍁] GITHUB       :  Hridoy0777          ║
...
\033[1;32m    ╚═════════════════  𝑹𝑰𝑫𝑫𝑼  𝑵𝑶𝑶𝑩  ══════════════╝
 ...
 \033[1;32m[\033[0;41;37m==========={ RIDDU-NOOB TOOL'S 🔥\033[0;37;41m FREE }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[NOOB™] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def Valobasa():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/Hridoy0777/HACKX_Pro2/blob/main/Update.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Bristy()
